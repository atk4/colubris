...
$s1->task('git',"clone -b master https://".$config['github_username']."@github.com/agiletech/colubris.git ./releases/$server_deploy_folder",array('pass'=>$config['ssh_password']));
